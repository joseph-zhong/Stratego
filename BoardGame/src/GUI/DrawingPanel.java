...
public final class DrawingPanel extends FileFilter
    ...
    */
    ...
    private DrawingPanel.ImagePanel imagePanel;         // real drawing surface
    ...
    private ArrayList<DrawingPanel.ImageFrame> frames;  // stores frames of animation to save
    private DrawingPanel.Gif89Encoder encoder;
    ...
    public DrawingPanel(int width, int height) {
        ...
        if (isGraphical()) {
            ...
            imagePanel = new DrawingPanel.ImagePanel(image);
        ...
        if (e.getSource() instanceof Timer) {
            ...
            if (shouldDiff() &&
                ...
                try {
                    ...
                    DrawingPanel.DiffImage diff = new DrawingPanel.DiffImage(expected, actual);
    ...
    public void saveAnimated(String filename) throws IOException {
        ...
        frames.add(new DrawingPanel.ImageFrame(getImage(), 5000));
        ...
        try {
            for (int i = 0; i < frames.size(); i++) {
                DrawingPanel.ImageFrame imageFrame = frames.get(i);
        ...
        if (isAnimated() && shouldSave() && !isMultiple()) {
            try {
                if (frames.size() < MAX_FRAMES) {
                    frames.add(new DrawingPanel.ImageFrame(getImage(), millis));
                }
    ...
    private void compareToFile() {
        ...
        try {
            ...
            new DrawingPanel.DiffImage(chooser.getSelectedFile().toString(), tempFile);
        } catch (IOException ioe) {
            JOptionPane.showMessageDialog(frame,
    ...
    private void compareToURL() {
        ...
        try {
            ...
            if (filenames.isEmpty()) {
                ...
                new DrawingPanel.DiffImage(fileURL, tempFile);
            }
    ...
    private void initializeAnimation() {
        frames = new ArrayList<DrawingPanel.ImageFrame>();
        encoder = new DrawingPanel.Gif89Encoder();
        /*
        try {
...
*/
     ...
     * @see IndexGif89Frame
     */
    class DirectGif89Frame extends DrawingPanel.Gif89Frame {
    ...
    class Gif89Encoder {
      ...
      private DrawingPanel.GifColorTable colorTable;
      private int          bgIndex = 0;
      private int          loopCount = 1;
      private String        theComments;
      private Vector<DrawingPanel.Gif89Frame> vFrames = new Vector<DrawingPanel.Gif89Frame>();
      ...
      public Gif89Encoder()
      {
        ...
        colorTable = new DrawingPanel.GifColorTable();
      }
      ...
      {
        colorTable = new DrawingPanel.GifColorTable(colors);
      }
       ...
       */
      public DrawingPanel.Gif89Frame getFrameAt(int index)
      {
       ...
       */
      public void addFrame(DrawingPanel.Gif89Frame gf) throws IOException
      {
        accommodateFrame(gf);
      ...
      {
        DrawingPanel.DirectGif89Frame frame = new DrawingPanel.DirectGif89Frame(image);
        addFrame(frame);
      }
      ...
      throws IOException
      {
        addFrame(new DrawingPanel.IndexGif89Frame(width, height, ci_pixels));
      }
       ...
       */
      public void insertFrame(int index, DrawingPanel.Gif89Frame gf) throws IOException
      {
        accommodateFrame(gf);
      ...
      public void encode(OutputStream out) throws IOException
      {
        ...
        for (int i = 0; i < nframes; ++i) {
          DrawingPanel.DirectGif89Frame frame = (DrawingPanel.DirectGif89Frame) vFrames.elementAt(i);
      ...
      public void startEncoding(OutputStream out, Image image, int delay) throws IOException
      {
        ...
        DrawingPanel.Gif89Frame gf = new DrawingPanel.DirectGif89Frame(image);
        accommodateFrame(gf);
      ...
      public void setBackground(Color color) {
          ...
          if (bgIndex < 0) {
              try {
                  ...
                  g.setColor(color);
                  g.fillRect(0, 0, 2, 2);
                  DrawingPanel.DirectGif89Frame frame = new DrawingPanel.DirectGif89Frame(img);
      ...
      //----------------------------------------------------------------------------
      private void accommodateFrame(DrawingPanel.Gif89Frame gf) throws IOException
      {
    ...
    class GifColorTable {
      ...
      private DrawingPanel.ReverseColorMap ciLookup; // cumulative rgb-to-ci lookup table

      //----------------------------------------------------------------------------
      GifColorTable()
      {
        ciLookup = new DrawingPanel.ReverseColorMap();  // puts us into "auto-detect mode"
      }
      ...
      //----------------------------------------------------------------------------
      void processPixels(DrawingPanel.Gif89Frame gf) throws IOException
      {
        if (gf instanceof DrawingPanel.DirectGif89Frame)
          filterPixels((DrawingPanel.DirectGif89Frame) gf);
        else
          trackPixelUsage((DrawingPanel.IndexGif89Frame) gf);
      }
      ...
      //----------------------------------------------------------------------------
      private void filterPixels(DrawingPanel.DirectGif89Frame dgf) throws IOException
      {
        if (ciLookup == null)
      ...
      //----------------------------------------------------------------------------
      private void trackPixelUsage(DrawingPanel.IndexGif89Frame igf) throws IOException
      {
    ...
    class ReverseColorMap {
      ...
      private DrawingPanel.ReverseColorMap.ColorRecord[] hTable = new DrawingPanel.ReverseColorMap.ColorRecord[HCAPACITY];
      ...
      {
        DrawingPanel.ReverseColorMap.ColorRecord rec;
      ...
      void put(int rgb, int ipalette)
      {
        ...
        hTable[itable] = new DrawingPanel.ReverseColorMap.ColorRecord(rgb, ipalette);
      }
    }
    ...
    abstract class Gif89Frame {
                  ...
                  int transparent_index) throws IOException
      {
        ...
        new DrawingPanel.GifPixelsEncoder(
     ...
     * @see DirectGif89Frame
     */
    class IndexGif89Frame extends DrawingPanel.Gif89Frame {
